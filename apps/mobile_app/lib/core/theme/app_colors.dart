...
class AppColors {
  ...
  static const Color lightTextPrimary   = Color(0xFF080808);
  ...
  static const Color darkSurface2       = Color(0xFF181818);
  static const Color darkSurface3       = Color(0xFF1E1E1E);
  static const Color darkTextPrimary    = Color(0xFFF0F0EE);
  static const Color darkTextSecondary  = Color(0xFF777777);
  static const Color darkTextMuted      = Color(0xFF3A3A3A);
  ...
  // Status/Common Colors
  static const Color success            = Color(0xFF1D9E75);
  static const Color warning            = Color(0xFFD4850A);
  static const Color error              = Color(0xFFC94040);
